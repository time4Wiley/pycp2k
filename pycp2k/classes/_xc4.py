...
from ._xc_kernel4 import _xc_kernel4
from ._hfx_kernel4 import _hfx_kernel4
from ._vdw_potential4 import _vdw_potential4
from ._gcp_potential4 import _gcp_potential4
...
class _xc4(InputSection):
    def __init__(self):
        ...
        self.XC_KERNEL = _xc_kernel4()
        self.HFX_KERNEL = _hfx_kernel4()
