...
from ._screening_in_w4 import _screening_in_w4
from ._bse_iterat4 import _bse_iterat4
from ._bse_spectrum4 import _bse_spectrum4
from ._nto_analysis4 import _nto_analysis4
...
class _bse4(InputSection):
    def __init__(self):
        ...
        self.SCREENING_IN_W = _screening_in_w4()
        self.BSE_ITERAT = _bse_iterat4()
        self.BSE_SPECTRUM = _bse_spectrum4()
        self.NTO_ANALYSIS = _nto_analysis4()
        self._name = "BSE"
