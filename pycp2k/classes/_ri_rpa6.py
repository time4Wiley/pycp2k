...
from ._hf17 import _hf17
from ._gw6 import _gw6
from ._exchange_correction6 import _exchange_correction6
...
class _ri_rpa6(InputSection):
    def __init__(self):
        ...
        self.HF_list = []
        self.GW = _gw6()
        self.EXCHANGE_CORRECTION = _exchange_correction6()
        self._name = "RI_RPA"
        ...
        self._repeated_subsections = {'HF': '_hf17'}
