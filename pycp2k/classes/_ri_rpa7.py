...
from ._hf20 import _hf20
from ._gw8 import _gw8
from ._exchange_correction7 import _exchange_correction7
...
class _ri_rpa7(InputSection):
    def __init__(self):
        ...
        self.HF_list = []
        self.GW = _gw8()
        self.EXCHANGE_CORRECTION = _exchange_correction7()
        self._name = "RI_RPA"
        ...
        self._repeated_subsections = {'HF': '_hf20'}
