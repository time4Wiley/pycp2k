...
from ._eri_mme_info9 import _eri_mme_info9
from ._cutoff_calib9 import _cutoff_calib9


class _eri_mme9(InputSection):
    def __init__(self):
        ...
        self.ERI_MME_INFO = _eri_mme_info9()
        self.CUTOFF_CALIB = _cutoff_calib9()
        self._name = "ERI_MME"
