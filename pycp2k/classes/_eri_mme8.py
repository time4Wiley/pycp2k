...
from ._eri_mme_info8 import _eri_mme_info8
from ._cutoff_calib8 import _cutoff_calib8


class _eri_mme8(InputSection):
    def __init__(self):
        ...
        self.ERI_MME_INFO = _eri_mme_info8()
        self.CUTOFF_CALIB = _cutoff_calib8()
        self._name = "ERI_MME"
