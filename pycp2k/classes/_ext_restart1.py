...
class _ext_restart1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Restart_file_name': 'RESTART_FILE_NAME', 'Binary_restart_file_name': 'BINARY_RESTART_FILE_NAME', 'Restart_default': 'RESTART_DEFAULT', 'Restart_counters': 'RESTART_COUNTERS', 'Restart_pos': 'RESTART_POS', 'Restart_vel': 'RESTART_VEL', 'Restart_randomg': 'RESTART_RANDOMG', 'Restart_shell_pos': 'RESTART_SHELL_POS', 'Restart_core_pos': 'RESTART_CORE_POS', 'Restart_optimize_input_variables': 'RESTART_OPTIMIZE_INPUT_VARIABLES', 'Restart_shell_velocity': 'RESTART_SHELL_VELOCITY', 'Restart_core_velocity': 'RESTART_CORE_VELOCITY', 'Restart_barostat': 'RESTART_BAROSTAT', 'Restart_barostat_thermostat': 'RESTART_BAROSTAT_THERMOSTAT', 'Restart_shell_thermostat': 'RESTART_SHELL_THERMOSTAT', 'Restart_thermostat': 'RESTART_THERMOSTAT', 'Restart_temperature_annealing': 'RESTART_TEMPERATURE_ANNEALING', 'Restart_cell': 'RESTART_CELL', 'Restart_metadynamics': 'RESTART_METADYNAMICS', 'Restart_walkers': 'RESTART_WALKERS', 'Restart_band': 'RESTART_BAND', 'Restart_qmmm': 'RESTART_QMMM', 'Restart_constraint': 'RESTART_CONSTRAINT', 'Restart_bsse': 'RESTART_BSSE', 'Restart_dimer': 'RESTART_DIMER', 'Restart_averages': 'RESTART_AVERAGES', 'Restart_rtp': 'RESTART_RTP', 'Restart_pint_pos': 'RESTART_PINT_POS', 'Restart_pint_vel': 'RESTART_PINT_VEL', 'Restart_pint_nose': 'RESTART_PINT_NOSE', 'Restart_pint_gle': 'RESTART_PINT_GLE', 'Restart_helium_pos': 'RESTART_HELIUM_POS', 'Restart_helium_permutation': 'RESTART_HELIUM_PERMUTATION', 'Restart_helium_force': 'RESTART_HELIUM_FORCE', 'Restart_helium_rng': 'RESTART_HELIUM_RNG', 'Restart_helium_densities': 'RESTART_HELIUM_DENSITIES', 'Restart_helium_averages': 'RESTART_HELIUM_AVERAGES'}
        self._repeated_keywords = {'Custom_path': 'CUSTOM_PATH'}
        self._aliases = {'External_file': 'Restart_file_name', 'Binary_restart_file': 'Binary_restart_file_name'}
