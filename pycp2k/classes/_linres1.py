...
from ._localize12 import _localize12
...
class _linres1(InputSection):
    def __init__(self):
        ...
        self._subsections = {'LOCALIZE': 'LOCALIZE', 'CURRENT': 'CURRENT', 'NMR': 'NMR', 'SPINSPIN': 'SPINSPIN', 'EPR': 'EPR', 'POLAR': 'POLAR', 'DCDR': 'DCDR', 'PRINT': 'PRINT'}
