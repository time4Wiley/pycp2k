...
from ._periodic_correction7 import _periodic_correction7
from ._bse7 import _bse7
from ._ic7 import _ic7
from ._kpoint_set8 import _kpoint_set8
from ._print127 import _print127


class _gw8(InputSection):
    def __init__(self):
        ...
        self.PERIODIC_CORRECTION = _periodic_correction7()
        self.BSE = _bse7()
        self.IC = _ic7()
        ...
        self._repeated_subsections = {'KPOINT_SET': '_kpoint_set8'}
