...
from ._ri_metric7 import _ri_metric7
from ._opt_ri_basis6 import _opt_ri_basis6


class _ri23(InputSection):
    def __init__(self):
        ...
        self.RI_METRIC = _ri_metric7()
        self.OPT_RI_BASIS = _opt_ri_basis6()
        self._name = "RI"
