...
class _update1(InputSection):
    def __init__(self):
        ...
        self._name = "UPDATE"
        self._keywords = {'Result_mo_index': 'RESULT_MO_INDEX', 'Result_marked_state': 'RESULT_MARKED_STATE', 'Result_spin_index': 'RESULT_SPIN_INDEX', 'Result_scale': 'RESULT_SCALE', 'Orig_mo_index': 'ORIG_MO_INDEX', 'Orig_marked_state': 'ORIG_MARKED_STATE', 'Orig_spin_index': 'ORIG_SPIN_INDEX', 'Orig_scale': 'ORIG_SCALE', 'Orig_type': 'ORIG_TYPE', 'Orig_ext_file_name': 'ORIG_EXT_FILE_NAME'}
