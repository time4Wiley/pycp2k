...
from ._localize15 import _localize15
from ._print106 import _print106


class _ri16(InputSection):
    def __init__(self):
        ...
        self.LOCALIZE = _localize15()
        self.PRINT = _print106()
        self._name = "RI"
        ...
        self._subsections = {'LOCALIZE': 'LOCALIZE', 'PRINT': 'PRINT'}
