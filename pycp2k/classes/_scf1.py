...
class _scf1(InputSection):
    def __init__(self):
        ...
        self.Ignore_convergence_failure = None
        self.Force_scf_calculation = None
        self.OT = _ot1()
