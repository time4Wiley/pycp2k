...
from ._screening_in_w2 import _screening_in_w2
from ._bse_iterat2 import _bse_iterat2
from ._bse_spectrum2 import _bse_spectrum2
from ._nto_analysis2 import _nto_analysis2


class _bse2(InputSection):
    def __init__(self):
        ...
        self.SCREENING_IN_W = _screening_in_w2()
        self.BSE_ITERAT = _bse_iterat2()
        self.BSE_SPECTRUM = _bse_spectrum2()
        self.NTO_ANALYSIS = _nto_analysis2()
        self._name = "BSE"
