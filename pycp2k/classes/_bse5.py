...
from ._screening_in_w5 import _screening_in_w5
from ._bse_iterat5 import _bse_iterat5
from ._bse_spectrum5 import _bse_spectrum5
from ._nto_analysis5 import _nto_analysis5


class _bse5(InputSection):
    def __init__(self):
        ...
        self.SCREENING_IN_W = _screening_in_w5()
        self.BSE_ITERAT = _bse_iterat5()
        self.BSE_SPECTRUM = _bse_spectrum5()
        self.NTO_ANALYSIS = _nto_analysis5()
        self._name = "BSE"
