...
from ._screening_in_w7 import _screening_in_w7
from ._bse_iterat7 import _bse_iterat7
from ._bse_spectrum7 import _bse_spectrum7
from ._nto_analysis8 import _nto_analysis8


class _bse7(InputSection):
    def __init__(self):
        ...
        self.SCREENING_IN_W = _screening_in_w7()
        self.BSE_ITERAT = _bse_iterat7()
        self.BSE_SPECTRUM = _bse_spectrum7()
        self.NTO_ANALYSIS = _nto_analysis8()
        self._name = "BSE"
