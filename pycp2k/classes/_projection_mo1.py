...
class _projection_mo1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Propagate_ref': 'PROPAGATE_REF', 'Reference_type': 'REFERENCE_TYPE', 'Ref_mo_file_name': 'REF_MO_FILE_NAME', 'Ref_mo_index': 'REF_MO_INDEX', 'Ref_mo_spin': 'REF_MO_SPIN', 'Sum_on_all_ref': 'SUM_ON_ALL_REF', 'Td_mo_index': 'TD_MO_INDEX', 'Td_mo_spin': 'TD_MO_SPIN', 'Sum_on_all_td': 'SUM_ON_ALL_TD'}
