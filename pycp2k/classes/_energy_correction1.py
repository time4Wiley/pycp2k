...
class _energy_correction1(InputSection):
    def __init__(self):
        ...
        self.Debug_external_method = None
        self.Skip_ec = None
        self.Mao = None
        ...
        self._keywords = {'Energy_functional': 'ENERGY_FUNCTIONAL', 'Harris_basis': 'HARRIS_BASIS', 'Debug_forces': 'DEBUG_FORCES', 'Debug_stress': 'DEBUG_STRESS', 'Debug_external_method': 'DEBUG_EXTERNAL_METHOD', 'Skip_ec': 'SKIP_EC', 'Mao': 'MAO', 'Mao_max_iter': 'MAO_MAX_ITER', 'Mao_eps_grad': 'MAO_EPS_GRAD', 'Mao_eps1': 'MAO_EPS1', 'Mao_iolevel': 'MAO_IOLEVEL', 'Algorithm': 'ALGORITHM', 'Factorization': 'FACTORIZATION', 'Eps_default': 'EPS_DEFAULT', 'Eps_filter': 'EPS_FILTER', 'Eps_lanczos': 'EPS_LANCZOS', 'Max_iter_lanczos': 'MAX_ITER_LANCZOS', 'Mu': 'MU', 'Fixed_mu': 'FIXED_MU', 'S_preconditioner': 'S_PRECONDITIONER', 'S_sqrt_method': 'S_SQRT_METHOD', 'S_sqrt_order': 'S_SQRT_ORDER', 'Sign_method': 'SIGN_METHOD', 'Sign_order': 'SIGN_ORDER', 'Dynamic_threshold': 'DYNAMIC_THRESHOLD', 'Non_monotonic': 'NON_MONOTONIC', 'Matrix_cluster_type': 'MATRIX_CLUSTER_TYPE', 'S_inversion': 'S_INVERSION', 'Report_all_sparsities': 'REPORT_ALL_SPARSITIES', 'Check_s_inv': 'CHECK_S_INV', 'Ot_initial_guess': 'OT_INITIAL_GUESS', 'Admm': 'ADMM'}
