...
class _gw2x1(InputSection):
    def __init__(self):
        ...
        self._aliases = {'Pseudo_cano': 'Pseudo_canonical'}
        self._attributes = ['Section_parameters']


    @property
    def Pseudo_cano(self):
        """
        See documentation for Pseudo_canonical
        """
        return self.Pseudo_canonical

    @Pseudo_cano.setter
    def Pseudo_cano(self, value):
        self.Pseudo_canonical = value
