...
from ._cphf13 import _cphf13


class _low_scaling7(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Memory_cut': 'MEMORY_CUT', 'Memory_info': 'MEMORY_INFO', 'Eps_filter': 'EPS_FILTER', 'Eps_filter_factor': 'EPS_FILTER_FACTOR', 'Eps_storage_scaling': 'EPS_STORAGE_SCALING', 'Do_kpoints': 'DO_KPOINTS', 'Kpoints': 'KPOINTS', 'Kpoint_weights_w': 'KPOINT_WEIGHTS_W', 'Exponent_tailored_weights': 'EXPONENT_TAILORED_WEIGHTS', 'Rel_cutoffs_chi_w': 'REL_CUTOFFS_CHI_W', 'Regularization_ri': 'REGULARIZATION_RI', 'Eps_eigval_s': 'EPS_EIGVAL_S', 'Make_chi_pos_definite': 'MAKE_CHI_POS_DEFINITE', 'Do_extrapolate_kpoints': 'DO_EXTRAPOLATE_KPOINTS', 'Trunc_coulomb_ri_x': 'TRUNC_COULOMB_RI_X', 'Rel_cutoff_trunc_coulomb_ri_x': 'REL_CUTOFF_TRUNC_COULOMB_RI_X', 'Keep_quadrature': 'KEEP_QUADRATURE', 'K_mesh_g_factor': 'K_MESH_G_FACTOR', 'Greens_function': 'GREENS_FUNCTION', 'Min_block_size': 'MIN_BLOCK_SIZE', 'Min_block_size_mo': 'MIN_BLOCK_SIZE_MO'}
