...
from ._ri_metric8 import _ri_metric8
from ._opt_ri_basis7 import _opt_ri_basis7


class _ri27(InputSection):
    def __init__(self):
        ...
        self.RI_METRIC = _ri_metric8()
        self.OPT_RI_BASIS = _opt_ri_basis7()
        self._name = "RI"
