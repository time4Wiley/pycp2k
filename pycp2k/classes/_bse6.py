...
from ._screening_in_w6 import _screening_in_w6
from ._bse_iterat6 import _bse_iterat6
from ._bse_spectrum6 import _bse_spectrum6
from ._nto_analysis6 import _nto_analysis6
...
class _bse6(InputSection):
    def __init__(self):
        ...
        self.SCREENING_IN_W = _screening_in_w6()
        self.BSE_ITERAT = _bse_iterat6()
        self.BSE_SPECTRUM = _bse_spectrum6()
        self.NTO_ANALYSIS = _nto_analysis6()
        self._name = "BSE"
