...
from ._eri_mme_info6 import _eri_mme_info6
from ._cutoff_calib6 import _cutoff_calib6


class _eri_mme6(InputSection):
    def __init__(self):
        ...
        self.ERI_MME_INFO = _eri_mme_info6()
        self.CUTOFF_CALIB = _cutoff_calib6()
        self._name = "ERI_MME"
