...
from ._dielec_aa_cuboidal1 import _dielec_aa_cuboidal1
from ._dielec_xaa_annular1 import _dielec_xaa_annular1


class _dielectric1(InputSection):
    def __init__(self):
        ...
        self._repeated_subsections = {'DIELEC_AA_CUBOIDAL': '_dielec_aa_cuboidal1', 'DIELEC_XAA_ANNULAR': '_dielec_xaa_annular1'}
    ...
    def DIELEC_AA_CUBOIDAL_add(self, section_parameters=None):
        new_section = _dielec_aa_cuboidal1()
    ...
    def DIELEC_XAA_ANNULAR_add(self, section_parameters=None):
        new_section = _dielec_xaa_annular1()
        if section_parameters is not None:
            if hasattr(new_section, 'Section_parameters'):
                new_section.Section_parameters = section_parameters
